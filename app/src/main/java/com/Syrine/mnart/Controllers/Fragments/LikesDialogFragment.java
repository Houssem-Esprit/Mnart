 ...
 */
public class LikesDialogFragment extends Fragment {


    private static final String TAG = CommentPage.class.getCanonicalName();
    CompositeDisposable likes_disposable = new CompositeDisposable();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        getLifecycle().addObserver(new LikesAdapter());
        ...
        getlikes(idPost,likesRecyclerView);
    ...
    public void getlikes(String idPost,RecyclerView rv){

        userApi.getLikessByPost(idPost)
                .toObservable()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<List<PostLikesResponse>>() {
                    @Override
                    public void onSubscribe(@io.reactivex.rxjava3.annotations.NonNull Disposable d) {
                        Log.d(TAG,"onSubscribe: created");
                        likes_disposable.add(d);
                    }

                    @Override
                    public void onNext(@io.reactivex.rxjava3.annotations.NonNull List<PostLikesResponse> obj) {
                        Log.d(TAG,"onNext: "+obj);

                        likesAdapter = new LikesAdapter(getContext(),getActivity(),obj);
